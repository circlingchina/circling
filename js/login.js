...
},{"./base":"../node_modules/airtable/lib/base.js","./record":"../node_modules/airtable/lib/record.js","./table":"../node_modules/airtable/lib/table.js","./airtable_error":"../node_modules/airtable/lib/airtable_error.js"}],"login.js":[function(require,module,exports) {
var Airtable = require("airtable");

var base = new Airtable({
  apiKey: "keyN6C9ddDWd2YTGi"
...
function attachIdentityListern() {
  ...
  netlifyIdentity.on('open', function () {
    return console.log('Widget opened');
  });
  netlifyIdentity.on('close', function () {
    return console.log('Widget closed');
  });
}
...
function updateNav(user) {
  if (user) {
    var user_link = document.getElementById('nav-user-name');
    ...
    var user_page_name = document.getElementById('user-name-label');

    if (user_page_name) {
      user_page_name.innerText = user.user_metadata.full_name + "你好";
    }

    var member_page_name = document.getElementById('member-name-label');
